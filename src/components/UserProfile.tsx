...
export const UserProfile = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-8 px-6 relative'>
      <div className='flex flex-col items-center '>
        <Avatar className='h-24 w-24 border-1 border-primary'>
      ...
      <div className='flex flex-col w-full gap-6 bg-card border p-4 rounded-md'>
        <div className='flex flex-col gap-3'>
          <div className='flex justify-between '>
            <div className='flex gap-2 items-center'>
              <Trophy size={18} />
              <span className='font-semibold'>Nivel {currentUserLevel}</span>
            </div>
            <span className='text-sm text-muted-foreground'>
              {userXP}/{totalXP} XP
            </span>
          </div>
          <Progress value={(userXP / totalXP) * 100} />
        </div>
        ...
        <div className='flex justify-between'>
          ...
          <span className='text-sm text-muted-foreground'>{totalCoins}</span>
        </div>
        <div className='flex justify-between'>
          <div className='flex gap-2 items-center'>
